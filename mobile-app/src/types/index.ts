...
export type Coach = { id: string; slug: string; name: string; specialty: string; bio: string; experienceYears: number; rating: number; clientsCount: number; expertise: string[]; photoUrl: string; sortOrder: number };
